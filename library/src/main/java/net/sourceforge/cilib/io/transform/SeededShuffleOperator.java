 ...
 */
public class SeededShuffleOperator implements DataOperator {

    private MersenneTwister random;

    public SeededShuffleOperator() {
        random = new MersenneTwister(Rand.nextLong());
    }

    public SeededShuffleOperator(SeededShuffleOperator copy) {
        random = copy.random;
    }

    public SeededShuffleOperator getClone() {
        return new SeededShuffleOperator(this);
    }
